          ...
          <div className="space-y-8">
            ...
            <Card className="max-w-4xl mx-auto border shadow-elegant">
              ...
              <CardContent className="p-6 space-y-6">
                ...
                <Button disabled={!selectedLength} onClick={handleStartRandomQuiz} className="w-full h-12 text-lg bg-gradient-primary">
              ...
              <CardContent className="p-6">
                <div className="flex flex-wrap gap-3 justify-center">
                  {alphagrams.map(({ alpha, words }, idx) => (
                    <Badge key={idx} variant="outline" className="px-4 py-3 text-lg font-mono tracking-wider border-2">
            ...
            <Card className="max-w-4xl mx-auto border shadow-elegant">
              <CardContent className="p-6">
                <div className="flex flex-col sm:flex-row gap-4">
                  <Input placeholder="TYPE YOUR ANSWER AND PRESS ENTER..." value={userInput} onChange={(e) => setUserInput(e.target.value.toUpperCase())} onKeyDown={(e) => e.key === "Enter" && handleInput()} className="flex-1 text-lg p-6 font-mono tracking-widest uppercase" autoFocus />
                  <Button onClick={handleInput} className="px-8 py-6 text-lg bg-gradient-primary">Submit</Button>
                </div>
