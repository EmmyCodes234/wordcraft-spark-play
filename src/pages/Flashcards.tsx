...
function getHooks(word, wordSet) {
    ...
    return (
      <div className="max-w-6xl mx-auto px-6 py-10">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold">Select a Flashcard Deck</h2>
          <Input
          ...
          {revealed && (
            <>
              <div className="space-y-2">
                ...
                {anagrams.length > 0 && (
                  <p className="text-sm">
                    Anagrams: <strong>{anagrams.join(", ")}</strong>
                  </p>
                )}
